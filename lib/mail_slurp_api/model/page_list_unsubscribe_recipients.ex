...
defmodule MailSlurpAPI.Model.PageListUnsubscribeRecipients do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"content" => [ListUnsubscribeRecipientProjection] | nil,
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageListUnsubscribeRecipients do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.ListUnsubscribeRecipientProjection, options)
