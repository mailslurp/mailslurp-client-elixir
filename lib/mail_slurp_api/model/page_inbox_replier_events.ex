...
defmodule MailSlurpAPI.Model.PageInboxReplierEvents do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"content" => [InboxReplierEventProjection] | nil,
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageInboxReplierEvents do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.InboxReplierEventProjection, options)
