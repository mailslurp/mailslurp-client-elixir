...
defmodule MailSlurpAPI.Model.PageOrganizationInboxProjection do
  ...
  @type t :: %__MODULE__{
    :"content" => [OrganizationInboxProjection] | nil,
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageOrganizationInboxProjection do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.OrganizationInboxProjection, options)
