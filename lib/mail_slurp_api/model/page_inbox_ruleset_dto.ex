...
defmodule MailSlurpAPI.Model.PageInboxRulesetDto do
  @moduledoc """
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageInboxRulesetDto do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.InboxRulesetDto, options)
