...
defmodule MailSlurpAPI.Model.PageScheduledJobs do
  @moduledoc """
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageScheduledJobs do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.ScheduledJob, options)
