...
defmodule MailSlurpAPI.Model.PageComplaint do
  @moduledoc """
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageComplaint do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.Complaint, options)
