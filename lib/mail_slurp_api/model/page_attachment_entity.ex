...
defmodule MailSlurpAPI.Model.PageAttachmentEntity do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"content" => [AttachmentProjection] | nil,
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageAttachmentEntity do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.AttachmentProjection, options)
