...
defmodule MailSlurpAPI.Model.PagePhoneNumberProjection do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"content" => [PhoneNumberProjection] | nil,
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PagePhoneNumberProjection do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.PhoneNumberProjection, options)
