...
defmodule MailSlurpAPI.Model.PageConnectorSyncEvents do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"content" => [ConnectorSyncEventProjection] | nil,
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageConnectorSyncEvents do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.ConnectorSyncEventProjection, options)
