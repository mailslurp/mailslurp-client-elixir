...
defmodule MailSlurpAPI.Model.PageContactProjection do
  @moduledoc """
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageContactProjection do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.ContactProjection, options)
