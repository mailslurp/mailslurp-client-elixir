...
defmodule MailSlurpAPI.Model.PageWebhookResult do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"content" => [WebhookResultEntity] | nil,
    :"empty" => boolean() | nil,
    :"first" => boolean() | nil,
    :"last" => boolean() | nil,
    :"number" => integer() | nil,
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageWebhookResult do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.WebhookResultEntity, options)
