...
defmodule MailSlurpAPI.Model.PageTrackingPixelProjection do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"content" => [TrackingPixelProjection] | nil,
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageTrackingPixelProjection do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.TrackingPixelProjection, options)
