...
defmodule MailSlurpAPI.Model.PageInboxRulesetProjection do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"content" => [InboxRulesetProjection] | nil,
    :"empty" => boolean() | nil,
    :"first" => boolean() | nil,
    :"last" => boolean() | nil,
    :"number" => integer() | nil,
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageInboxRulesetProjection do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.InboxRulesetProjection, options)
