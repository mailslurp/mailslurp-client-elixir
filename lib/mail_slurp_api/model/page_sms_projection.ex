...
defmodule MailSlurpAPI.Model.PageSmsProjection do
  @moduledoc """
...
defimpl Poison.Decoder, for: MailSlurpAPI.Model.PageSmsProjection do
  import MailSlurpAPI.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"content", :list, MailSlurpAPI.Model.SmsProjection, options)
