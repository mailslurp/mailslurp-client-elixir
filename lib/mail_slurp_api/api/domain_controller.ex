...
defmodule MailSlurpAPI.Api.DomainController do
  ...
  def get_domain(connection, id, opts \\ []) do
    optional_params = %{
  ...
  {:ok, %MailSlurpAPI.Model.DomainIssuesDto{}} on success
  {:error, info} on failure
  """
  @spec get_domain_issues(Tesla.Env.client, keyword()) :: {:ok, MailSlurpAPI.Model.DomainIssuesDto.t} | {:error, Tesla.Env.t}
  def get_domain_issues(connection, _opts \\ []) do
    %{}
    |> method(:get)
    |> url("/domains/issues")
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MailSlurpAPI.Model.DomainIssuesDto{}}
    ])
  end
  ...
  {:error, info} on failure
  """
  @spec get_domain_wildcard_catch_all_inbox(Tesla.Env.client, String.t, keyword()) :: {:ok, MailSlurpAPI.Model.InboxDto.t} | {:error, Tesla.Env.t}
  def get_domain_wildcard_catch_all_inbox(connection, id, _opts \\ []) do
    %{}
    |> method(:get)
    |> url("/domains/#{id}/wildcard")
    |> Enum.into([])
