...
defmodule MailSlurpAPI.Api.FormController do
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :to (String.t): The email address that submitted form should be sent to. Either this or _toAlias must be present for a form to be successfully submitted..
    - :to_alias (String.t): ID of an email alias to that form should be sent to. Aliases must be created before submission and can be used to hide an email address and reduce spam.
