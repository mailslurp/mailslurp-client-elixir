...
defmodule MailSlurpAPI.Api.SmsController do
  ...
  {:ok, %MailSlurpAPI.Model.ReplyForSms{}} on success
  {:error, info} on failure
  """
  @spec get_reply_for_sms_message(Tesla.Env.client, String.t, keyword()) :: {:ok, MailSlurpAPI.Model.ReplyForSms.t} | {:error, Tesla.Env.t}
  def get_reply_for_sms_message(connection, sms_id, _opts \\ []) do
    %{}
    |> method(:get)
    |> url("/sms/#{sms_id}/reply")
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MailSlurpAPI.Model.ReplyForSms{}}
    ])
  end
  ...
  {:ok, %MailSlurpAPI.Model.SentSmsDto{}} on success
  {:error, info} on failure
  """
  @spec reply_to_sms_message(Tesla.Env.client, String.t, MailSlurpAPI.Model.SmsReplyOptions.t, keyword()) :: {:ok, MailSlurpAPI.Model.SentSmsDto.t} | {:error, Tesla.Env.t}
  def reply_to_sms_message(connection, sms_id, sms_reply_options, _opts \\ []) do
    %{}
    |> method(:post)
    |> url("/sms/#{sms_id}/reply")
    |> add_param(:body, :body, sms_reply_options)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MailSlurpAPI.Model.SentSmsDto{}}
    ])
  end
end
