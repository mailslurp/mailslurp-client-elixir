...
defmodule MailSlurpAPI.Api.SmsController do
  ...
  {:ok, %MailSlurpAPI.Model.SmsMessage{}} on success
  {:error, info} on failure
  """
  @spec get_sms_message(Tesla.Env.client, String.t, keyword()) :: {:ok, MailSlurpAPI.Model.SmsMessage.t} | {:error, Tesla.Env.t}
  def get_sms_message(connection, sms_id, _opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MailSlurpAPI.Model.SmsMessage{}}
    ])
  end
