...
defmodule MailSlurpAPI.Api.EmailController do
  ...
  - connection (MailSlurpAPI.Connection): Connection to server
  - attachment_id (String.t): attachmentId
  - email_id (String.t): emailId
  - opts (KeywordList): [optional] Optional parameters
    - :api_key (String.t): Can pass apiKey in url for this request if you wish to download the file in a browser
  ## Returns
  ...
  - opts (KeywordList): [optional] Optional parameters
    ...
    - :size (integer()): Optional page size in email list pagination
