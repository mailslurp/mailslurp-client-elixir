...
defmodule MailSlurpAPI.Api.CommonActionsController do
  ...
  """
  @spec create_new_email_address(Tesla.Env.client, boolean(), keyword()) :: {:ok, MailSlurpAPI.Model.Inbox.t} | {:error, Tesla.Env.t}
  def create_new_email_address(connection, use_domain_pool, _opts \\ []) do
    %{}
    |> method(:post)
    |> url("/createInbox")
    |> add_param(:query, :"useDomainPool", use_domain_pool)
    |> Enum.into([])
  ...
  {:error, info} on failure
  """
  @spec create_new_email_address1(Tesla.Env.client, boolean(), keyword()) :: {:ok, MailSlurpAPI.Model.Inbox.t} | {:error, Tesla.Env.t}
  def create_new_email_address1(connection, use_domain_pool, _opts \\ []) do
    %{}
    |> method(:post)
    |> url("/newEmailAddress")
    |> add_param(:query, :"useDomainPool", use_domain_pool)
