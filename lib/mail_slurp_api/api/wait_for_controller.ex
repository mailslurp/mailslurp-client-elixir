...
defmodule MailSlurpAPI.Api.WaitForController do
  ...
  {:error, info} on failure
  """
  @spec wait_for_matching_emails(Tesla.Env.client, MailSlurpAPI.Model.MatchOptions.t, keyword()) :: {:ok, list(MailSlurpAPI.Model.EmailPreview.t)} | {:error, Tesla.Env.t}
  def wait_for_matching_emails(connection, match_options, opts \\ []) do
    optional_params = %{
      :"before" => :query,
      :"count" => :query,
      :"delay" => :query,
