...
defmodule MailSlurpAPI.Api.SentEmailsController do
  ...
  {:ok, %MailSlurpAPI.Model.DeliveryStatus{}} on success
  {:error, info} on failure
  """
  @spec get_sent_delivery_status(Tesla.Env.client, String.t, keyword()) :: {:ok, MailSlurpAPI.Model.DeliveryStatus.t} | {:error, Tesla.Env.t}
  def get_sent_delivery_status(connection, delivery_id, _opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MailSlurpAPI.Model.DeliveryStatus{}}
    ])
  end
