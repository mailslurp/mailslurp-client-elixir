...
defmodule MailSlurpAPI.Api.InboxController do
  ...
  {:ok, %MailSlurpAPI.Model.ScheduledJobDto{}} on success
  {:error, info} on failure
  """
  @spec cancel_scheduled_job(Tesla.Env.client, String.t, keyword()) :: {:ok, MailSlurpAPI.Model.ScheduledJobDto.t} | {:error, Tesla.Env.t}
  def cancel_scheduled_job(connection, job_id, _opts \\ []) do
    %{}
    |> method(:delete)
    |> url("/inboxes/scheduled-jobs/#{job_id}")
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MailSlurpAPI.Model.ScheduledJobDto{}}
    ])
  end
  ...
  {:error, info} on failure
  """
  @spec delete_all_inboxes_by_description(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  def delete_all_inboxes_by_description(connection, description, _opts \\ []) do
    %{}
    |> method(:delete)
    |> url("/inboxes/by-description")
  ...
  {:error, info} on failure
  """
  @spec delete_all_inboxes_by_name(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  def delete_all_inboxes_by_name(connection, name, _opts \\ []) do
    %{}
    |> method(:delete)
    |> url("/inboxes/by-name")
  ...
  {:error, info} on failure
  """
  @spec delete_all_inboxes_by_tag(Tesla.Env.client, String.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  def delete_all_inboxes_by_tag(connection, tag, _opts \\ []) do
    %{}
    |> method(:delete)
    |> url("/inboxes/by-tag")
  ...
  def does_inbox_exist(connection, email_address, opts \\ []) do
    optional_params = %{
      :"allowCatchAll" => :query
    }
    %{}
  ...
  {:error, info} on failure
  """
  @spec get_scheduled_job(Tesla.Env.client, String.t, keyword()) :: {:ok, MailSlurpAPI.Model.ScheduledJobDto.t} | {:error, Tesla.Env.t}
  def get_scheduled_job(connection, job_id, _opts \\ []) do
    %{}
    |> method(:get)
    |> url("/inboxes/scheduled-jobs/#{job_id}")
    |> Enum.into([])
  ...
  {:error, info} on failure
  """
  @spec send_with_schedule(Tesla.Env.client, String.t, MailSlurpAPI.Model.SendEmailOptions.t, keyword()) :: {:ok, MailSlurpAPI.Model.ScheduledJobDto.t} | {:error, Tesla.Env.t}
  def send_with_schedule(connection, inbox_id, send_email_options, opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 201, %MailSlurpAPI.Model.ScheduledJobDto{}}
    ])
  end
