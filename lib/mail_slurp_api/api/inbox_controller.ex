...
defmodule MailSlurpAPI.Api.InboxController do
  ...
  - opts (KeywordList): [optional] Optional parameters
    - :alias_for_limit_period_assessed_first_before_assessing_any_passed_limit_period (integer()): 
    ...
    - :sort_the_results_by_received_date_and_direction_asc_or_desc (String.t): 
  ...
  def get_emails(connection, inbox_id, opts \\ []) do
    optional_params = %{
      :"Alias for limit. Assessed first before assessing any passed limit." => :query,
      :"limit" => :query,
      :"Sort the results by received date and direction ASC or DESC" => :query,
      :"retryTimeout" => :query,
      :"delayTimeout" => :query,
      :"minCount" => :query,
      :"unreadOnly" => :query,
