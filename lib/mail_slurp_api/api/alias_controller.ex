...
defmodule MailSlurpAPI.Api.AliasController do
  ...
  """
  @spec create_alias(Tesla.Env.client, MailSlurpAPI.Model.CreateAliasOptions.t, keyword()) :: {:ok, MailSlurpAPI.Model.Alias.t} | {:error, Tesla.Env.t}
  ...
  - verification_token (String.t): verificationToken
  - opts (KeywordList): [optional] Optional parameters
  ## Returns

  {:ok, %MailSlurpAPI.Model.AliasVerificationResult{}} on success
  {:error, info} on failure
  """
  @spec get_alias_verification(Tesla.Env.client, String.t, String.t, String.t, keyword()) :: {:ok, MailSlurpAPI.Model.AliasVerificationResult.t} | {:error, Tesla.Env.t}
  def get_alias_verification(connection, alias_id, email_address, verification_token, _opts \\ []) do
    %{}
    |> method(:get)
    |> url("/aliases/#{alias_id}/verification")
    |> add_param(:query, :"emailAddress", email_address)
    |> add_param(:query, :"verificationToken", verification_token)
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MailSlurpAPI.Model.AliasVerificationResult{}},
      { 401, false},
      { 403, false},
      { 404, false}
    ])
