...
defmodule MailSlurpAPI.Api.MissedEmailController do
  ...
  {:ok, %MailSlurpAPI.Model.MissedEmailDto{}} on success
  {:error, info} on failure
  """
  @spec get_missed_email(Tesla.Env.client, String.t, keyword()) :: {:ok, MailSlurpAPI.Model.MissedEmailDto.t} | {:error, Tesla.Env.t}
  def get_missed_email(connection, missed_email_id, _opts \\ []) do
    ...
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, %MailSlurpAPI.Model.MissedEmailDto{}}
    ])
  end
  ...
  {:error, info} on failure
  """
  @spec restore_missed_emails(Tesla.Env.client, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  def restore_missed_emails(connection, _opts \\ []) do
    %{}
    |> method(:post)
    |> url("/missed-emails/restore")
    |> Enum.into([])
    |> (&Connection.request(connection, &1)).()
    |> evaluate_response([
      { 200, false}
  ...
  {:error, info} on failure
  """
  @spec wait_for_nth_missed_email(Tesla.Env.client, integer(), keyword()) :: {:ok, MailSlurpAPI.Model.MissedEmailDto.t} | {:error, Tesla.Env.t}
